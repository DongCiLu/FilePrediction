...
class CrushMap():
    ...
    def __init__(self):
        ...
        '''
        self.threshold = 0.0
        self.threshold_total = 0.0
        self.threshold_cnt = 0.0
        self.crush_buckets = []
        self.crush_rules = []
        ...
        self.num_total_tries = 100 # change from 19 to 100 to guarantee replica number for small crush map
    ...
    def clear_map_threshold(self):
        self.threshold_total = 0.0
        self.threshold_cnt = 0.0
        # Attention: due to ugly implementation reason, don't clear self.threshold here

    def map_threshold(self, threshold):
        self.threshold_total += threshold
        self.threshold_cnt += 1
        self.threshold = self.threshold_total / self.threshold_cnt
    ...
    def get_mapping_using_rule(self, rule_id, x, weight, weight_max, result_max):
        ...
        for step in range(self.crush_rules[rule_id].len):
            ...
            # CRUSH_RULE_EMIT
                ...
                res = [None]*w_size # exclude Nonetype from result set
                for i in range(w_size):
